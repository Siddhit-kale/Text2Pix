            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
                <div className="grid grid-cols-2 md:grid-cols-12 gap-6">
                    ...
                    <div className="col-span-2 md:col-span-4">
                        ...
                        <div className="flex items-center gap-3">
                            <a href="https://github.com/Siddhit-kale/Text2Pix" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
                                <img src={github} alt="github" className="w-4 h-4" />
                            </a>
                            <a href="https://www.linkedin.com/in/siddhit-kale-3a598b293/" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
                ...
                <div className="mt-8 pt-4 text-center border-t border-gray-100">
                    <p className="text-sm text-gray-600">
                        © {currentYear} Imagify || Siddhit. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
